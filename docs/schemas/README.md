...
| Schema (to be added) | Source Type              | Output              |
|----------------------|--------------------------|---------------------|
...
> **Status**: Schemas are planned for v0.7.0. v0.6.5 ships the Rust types
> as the source of truth, documented in `docs/AGENTS.md` and the inline
> `///` doc comments on each struct. JSON schema files will be generated
> via `schemars` derive in a future version.
